...
void SP_monster_dog_prototype(edict_t* self)
{
	...
	sound_melee.assign("dog_prototype/dattack1_s.wav");
	sound_death.assign("dog_prototype/ddeath_s.wav");
	sound_pain.assign("dog_prototype/dpain1_s.wav");
	sound_sight.assign("dog_prototype/dsight_s.wav");
	sound_search.assign("dog_prototype/idle_s.wav");
