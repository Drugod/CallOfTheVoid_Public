...
void ogre_prototype_idle(edict_t* self)
{
	if (frandom() < 0.2)
		gi.sound(self, CHAN_VOICE, sound_idle, 1, ATTN_NORM, 0);
}

void ogre_prototype_idle2(edict_t* self)
{
	if (frandom() < 0.2)
		gi.sound(self, CHAN_VOICE, sound_idle2, 1, ATTN_NORM, 0);
}

void ogre_prototype_drag(edict_t* self)
{
	if (frandom() < 0.2)
...
MMOVE_T(ogre_prototype_move_stand) = { 0, 8, ogre_prototype_frames_stand, NULL };

MONSTERINFO_STAND(ogre_prototype_stand) (edict_t* self) -> void
{
...
MMOVE_T(ogre_prototype_move_run) = { 25, 32, ogre_prototype_frames_run, NULL };

MONSTERINFO_RUN(ogre_prototype_run) (edict_t* self) -> void
{
...
mframe_t ogre_prototype_frames_walk[] = {
	{ai_walk, 3},
	{ai_walk, 2},
	{ai_walk, 2, ogre_prototype_idle},
	{ai_walk, 2},
	{ai_walk, 2},
	{ai_walk, 5, ogre_prototype_drag},
	{ai_walk, 3},
	{ai_walk, 2},
	{ai_walk, 3},
	{ai_walk, 1},
...
MMOVE_T(ogre_prototype_move_walk) = { 9, 24, ogre_prototype_frames_walk, NULL };

MONSTERINFO_WALK(ogre_prototype_walk) (edict_t* self) -> void
{
	M_SetAnimation(self, &ogre_prototype_move_walk);
}

void OgrePrototypeChainsaw(edict_t* self)
{
	vec3_t dir;
...
mframe_t ogre_prototype_frames_smash[] = {
	...
	{ai_charge, 1},
	{ai_charge, 4},
	{ai_charge, 14,OgrePrototypeChainsaw},
	{ai_charge, 14,OgrePrototypeChainsaw},
	{ai_charge, 20,OgrePrototypeChainsaw},
	{ai_charge, 23,OgrePrototypeChainsaw},
	{ai_charge, 10,OgrePrototypeChainsaw},
	{ai_charge, 12,OgrePrototypeChainsaw},
	{ai_charge, 1},
	{ai_charge, 4},
	{ai_charge, 12},
	{ai_charge, 0 }
...
mframe_t ogre_prototype_frames_swing[] = {
	...
	{ai_charge, 1,	NULL},
	{ai_charge, 4,	NULL},
	{ai_charge, 19,	OgrePrototypeChainsaw},
	{ai_charge, 13,	OgrePrototypeChainsaw},
	{ai_charge, 10,	OgrePrototypeChainsaw},
	{ai_charge, 10,	OgrePrototypeChainsaw},
	{ai_charge, 10,	OgrePrototypeChainsaw},
	{ai_charge, 10,	OgrePrototypeChainsaw},
...
{
	if (frandom() > 0.5)
		M_SetAnimation(self, &ogre_prototype_move_smash);
	else
		M_SetAnimation(self, &ogre_prototype_move_swing);
...
MMOVE_T(ogre_prototype_move_attack) = { 61, 66, ogre_prototype_frames_attack, ogre_prototype_run };

MONSTERINFO_ATTACK(ogre_prototype_attack) (edict_t* self) -> void
{
...
PAIN(ogre_prototype_pain) (edict_t* self, edict_t* other, float kick, int damage, const mod_t& mod) -> void
{
	...
	if (r < 0.25)
	{
		M_SetAnimation(self, &ogre_prototype_move_pain1);
		self->pain_debounce_time = level.time + 1_sec;
	}
	else if (r < 0.5)
	{
		M_SetAnimation(self, &ogre_prototype_move_pain2);
		self->pain_debounce_time = level.time + 1_sec;
	}
	else if (r < 0.75)
	{
		M_SetAnimation(self, &ogre_prototype_move_pain3);
		self->pain_debounce_time = level.time + 1_sec;
	}
	else if (r < 0.88)
	{
		M_SetAnimation(self, &ogre_prototype_move_pain4);
		self->pain_debounce_time = level.time + 2_sec;
	}
	else
	{
		M_SetAnimation(self, &ogre_prototype_move_pain5);
		self->pain_debounce_time = level.time + 2_sec;
	}
}

MONSTERINFO_SETSKIN(ogre_prototype_setskin) (edict_t* self) -> void
{
...
void ogre_prototype_dead(edict_t* self)
{
	self->mins = { -32, -32, -24 };
	self->maxs = { 32, 32, -8 };
...
DIE(ogre_prototype_die) (edict_t* self, edict_t* inflictor, edict_t* attacker, int damage, const vec3_t& point, const mod_t& mod) -> void
{
	...
	if (frandom() < 0.5)
		M_SetAnimation(self, &ogre_prototype_move_death1);
	else
...
void SP_monster_ogre_prototype(edict_t* self)
{
	...
	self->pain = ogre_prototype_pain;
	self->die = ogre_prototype_die;

	self->monsterinfo.stand = ogre_prototype_stand;
	self->monsterinfo.walk = ogre_prototype_walk;
	self->monsterinfo.run = ogre_prototype_run;
	self->monsterinfo.attack = ogre_prototype_attack;
	self->monsterinfo.melee = ogre_prototype_melee;
	self->monsterinfo.sight = ogre_prototype_sight;
	...
	if (irandom(2) == 0) {		//appear random skin
		...
		self->s.skinnum = 2;
		self->s.modelindex = gi.modelindex("models/monsters/ogre_prototype/tris2.md2");
	}
