...
MMOVE_T(grunt_move_stand) = { 0, 7, grunt_frames_stand, NULL };

MONSTERINFO_STAND(grunt_stand) (edict_t* self) -> void
{
...
MMOVE_T(grunt_move_run) = { 73, 80, grunt_frames_run, NULL };

MONSTERINFO_RUN(grunt_run) (edict_t* self) -> void
{
...
MMOVE_T(grunt_move_walk) = { 90, 113, grunt_frames_walk, NULL };


MONSTERINFO_WALK(grunt_walk) (edict_t* self) -> void
{
...
MMOVE_T(grunt_move_attack) = { 81, 89, grunt_frames_attack, grunt_run };

MONSTERINFO_ATTACK(grunt_attack) (edict_t* self) -> void
{
	M_SetAnimation(self, &grunt_move_attack);
}

MONSTERINFO_SETSKIN(grunt_setskin) (edict_t* self) -> void
{
...
MMOVE_T(grunt_move_pain1) = { 40, 45, grunt_frames_pain1, grunt_run };
...
MMOVE_T(grunt_move_pain2) = { 46, 59, grunt_frames_pain2, grunt_run };
...
MMOVE_T(grunt_move_pain3) = { 60, 72, grunt_frames_pain3, grunt_run };

// Pain
PAIN(grunt_pain) (edict_t* self, edict_t* other, float kick, int damage, const mod_t& mod) -> void
{
	float r;
...
MMOVE_T(grunt_move_death1) = { 8, 17, grunt_frames_death1, grunt_dead };

// Death (2)
mframe_t grunt_frames_death2[] = {
	{ai_move, 0,		NULL},
	{ai_move, -5,		NULL},
	{ai_move, -4,		NULL},
	{ai_move, -13,		NULL},
...
MMOVE_T(grunt_move_death2) = { 18, 28, grunt_frames_death2, grunt_dead };

// Death
DIE(grunt_die) (edict_t* self, edict_t* inflictor, edict_t* attacker, int damage, const vec3_t& point, const mod_t& mod) -> void
{
...
// Sight
MONSTERINFO_SIGHT(grunt_sight) (edict_t* self, edict_t* other) -> void
{
	gi.sound(self, CHAN_VOICE, sound_sight, 1, ATTN_NORM, 0);
}

// Search
MONSTERINFO_SEARCH(grunt_search) (edict_t* self) -> void
{
