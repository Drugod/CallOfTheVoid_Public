...
{
	//DRUGOD
	if (item == IT_AMMO_MINI_CELLS) {//IT_AMMO_MINI_CELLS
		item = IT_AMMO_CELLS;
		max = other->client->pers.max_ammo[AMMO_CELLS];
	}
	if (item == IT_AMMO_MINI_SHELLS) {//IT_AMMO_MINI_SHELLS
		item = IT_AMMO_SHELLS;
		max = other->client->pers.max_ammo[AMMO_SHELLS];
	}
	if (item == IT_AMMO_MINI_BULLETS) {//IT_AMMO_MINI_BULLETS
		item = IT_AMMO_BULLETS;
		max = other->client->pers.max_ammo[AMMO_BULLETS];
	}
	if (item == IT_AMMO_MINI_ROCKETS) {//IT_AMMO_MINI_ROCKETS
		item = IT_AMMO_ROCKETS;
		max = other->client->pers.max_ammo[AMMO_ROCKETS];
	}
	if (item == IT_AMMO_MINI_GRENADES) {//IT_AMMO_MINI_GRENADES
		item = IT_AMMO_GRENADES;
		max = other->client->pers.max_ammo[AMMO_GRENADES];
	}
	if (item == IT_AMMO_MINI_FLECHETTES) {//IT_AMMO_MINI_FLECHETTES
		item = IT_AMMO_FLECHETTES;
		max = other->client->pers.max_ammo[AMMO_FLECHETTES];
	}
...
{
	//DRUGOD COMO HACER DEBUG
	//gi.Com_PrintFmt("item->id = {}\n", item->id);
...
*/
	{
		...
		/* view_model */ nullptr,
		/* icon */ "k_datacd",
		/* use_name */  "Diskette",//"Data CD",
		/* pickup_name */  "Diskette",//"$item_data_cd",
		/* pickup_name_definite */ "Diskette",//"$item_data_cd_def",
		/* quantity */ 0,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
...
//DRUGOD
	{
		/* id */ IT_AMMO_MINI_CELLS,
		/* classname */ "ammo_mini_cells",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
	...
	{
		/* id */ IT_AMMO_MINI_SHELLS,
		/* classname */ "ammo_mini_shells",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		...
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_MINI_SHELLS
	},

	{
		/* id */ IT_AMMO_MINI_BULLETS,
		/* classname */ "ammo_mini_bullets",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		...
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_MINI_BULLETS
	},

	{
		/* id */ IT_AMMO_MINI_ROCKETS,
		/* classname */ "ammo_mini_rockets",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		...
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_MINI_ROCKETS
	},

	{
		/* id */ IT_AMMO_MINI_FLECHETTES,
		/* classname */ "ammo_mini_flechettes",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		...
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_MINI_FLECHETTES
	},

	{
		/* id */ IT_AMMO_MINI_GRENADES,
		/* classname */ "ammo_mini_grenades",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		...
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_MINI_GRENADES,
	},//DRUGOD KEYS & RUNES
	/*QUAKED KEY QUAKE 1 RUNE END1 (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
	...
	/*QUAKED KEY QUAKE 1 RUNE END2 (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
	...
	/*QUAKED KEY QUAKE 1 RUNE END3 (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
	...
	/*QUAKED KEY QUAKE 1 RUNE END4 (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
	...
	/*QUAKED KEY QUAKE 1 BASE GOLD KEY (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
		...
		///* pickup_name */  "$item_q1_base_gold_key",
		///* pickup_name_definite */ "$item_q1_base_gold_key_def",
	...
	/*QUAKED KEY QUAKE 1 BASE SILVER KEY (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
		...
		///* pickup_name */  "$item_q1_base_silver_key",
		///* pickup_name_definite */ "$item_q1_base_silver_key_def",
	...
	/*QUAKED KEY QUAKE 1 MEDIEVAL GOLD KEY (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
	...
	/*QUAKED KEY QUAKE 1 MEDIEVAL SILVER KEY (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
	...
	/*QUAKED KEY QUAKE 1 RUNIC GOLD KEY (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
	...
	/*QUAKED KEY QUAKE 1 RUNIC SILVER KEY (0 .5 .8) (-16 -16 -16) (16 16 16)*/
	{
