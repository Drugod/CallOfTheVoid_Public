...
// Walk
mframe_t shalrath_strogg_frames_walk[] = {
	{ai_walk, 0, NULL},
	{ai_walk, 3, NULL},
	{ai_walk, 4, NULL},
	{ai_walk, 5, NULL},
...
MMOVE_T(shalrath_strogg_move_walk) = { 0, 11, shalrath_strogg_frames_walk, NULL };

MONSTERINFO_WALK(shalrath_strogg_walk) (edict_t* self) -> void
{
	M_SetAnimation(self, &shalrath_strogg_move_walk);
}

// Run
mframe_t shalrath_strogg_frames_run [] = {
	{ai_run, 0, NULL},
	{ai_run, 3, NULL},
	{ai_run, 4, NULL},
	{ai_run, 5, NULL},
...
MMOVE_T(shalrath_strogg_move_run) = {0, 11, shalrath_strogg_frames_run, NULL};

MONSTERINFO_RUN(shalrath_strogg_run) (edict_t *self) -> void
{
	M_SetAnimation(self, &shalrath_strogg_move_run);
}

void shalrath_strogg_roar(edict_t *self)
{
	gi.sound(self, CHAN_VOICE, sound_attack, 1, ATTN_NORM, 0);
}

TOUCH (shalrath_strogg_pod_touch) (edict_t* self, edict_t* other, const trace_t& tr, bool other_touching_self) -> void
{
	if (other == self->owner)
		return;
...
THINK(shalrath_strogg_pod_home) (edict_t* self) -> void
{
	vec3_t			end;
	vec3_t			dir;
	...
	self->think = shalrath_strogg_pod_home;
}

DIE(fire_shalrath_strogg_pod_die) (edict_t* self, edict_t* other, edict_t* inflictor, int damage, const vec3_t& point, const mod_t& mod) -> void
{
	if (mod.id == MOD_CRUSH)
		CTFResetGrapple(self);
}

void fire_shalrath_strogg_pod(edict_t *self, vec3_t start, vec3_t dir, int damage, int speed)
{
	edict_t	*pod;
	...
	pod->owner = self;
	pod->touch = shalrath_strogg_pod_touch;
	pod->nextthink = level.time + 0.1_ms;
	pod->think = shalrath_strogg_pod_home;
	pod->dmg = damage;
	pod->die = fire_shalrath_strogg_pod_die;
	pod->enemy = self->enemy;
	gi.linkentity(pod);
	gi.sound(self, CHAN_WEAPON, sound_fire, 1, ATTN_NORM, 0);
}

void FireShalrathStroggPod(edict_t *self)
{
	...
	fire_shalrath_strogg_pod(self, start, dir, 40, 400);
}

// Attack
mframe_t shalrath_strogg_frames_attack [] =
{
...
MMOVE_T(shalrath_strogg_move_attack) = {12, 25, shalrath_strogg_frames_attack, shalrath_strogg_run};

MONSTERINFO_ATTACK (shalrath_strogg_attack) (edict_t *self) -> void
{
	if (self->timestamp <= level.time && frandom() <= 0.5f)
	{
...
// Pain
mframe_t shalrath_strogg_frames_pain1 [] ={
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
...
MMOVE_T(shalrath_strogg_move_pain1) = {56, 60, shalrath_strogg_frames_pain1, shalrath_strogg_run};

mframe_t shalrath_strogg_frames_pain2 [] ={
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
...
MMOVE_T(shalrath_strogg_move_pain2) = {61, 76, shalrath_strogg_frames_pain2, shalrath_strogg_run};

PAIN(shalrath_strogg_pain) (edict_t* self, edict_t* other, float kick, int damage, const mod_t& mod) -> void
{
	if (skill->value == 3)
		return;
...
MONSTERINFO_SETSKIN(shalrath_strogg_setskin) (edict_t* self) -> void
{
...
void shalrath_strogg_dead(edict_t *self)
{
	self->mins = { -32, -32, -24 };
	self->maxs = { 32, 32, -8 };
...
// Death
mframe_t shalrath_strogg_frames_death [] ={
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
...
MMOVE_T(shalrath_strogg_move_death) = {77, 102, shalrath_strogg_frames_death, shalrath_strogg_dead};

DIE(shalrath_strogg_die) (edict_t* self, edict_t* inflictor, edict_t* attacker, int damage, const vec3_t& point, const mod_t& mod) -> void
{
	...
	if (self->health <= self->gib_health)
	{
		...
		ThrowGibs(self, damage, {
			...
			{ "models/monsters/shalrathstrogg/gibs/g_arm.md2" },
			{ "models/monsters/shalrathstrogg/gibs/g_arm.md2" },
			{ "models/monsters/shalrathstrogg/gibs/g_leg.md2" },
			{ "models/monsters/shalrathstrogg/gibs/g_leg.md2" },
			{ "models/monsters/shalrathstrogg/gibs/g_leg.md2" },
			{ "models/monsters/shalrathstrogg/gibs/g_leg.md2" },
			{ "models/monsters/shalrathstrogg/gibs/g_head.md2", GIB_HEAD }
			});
		self->deadflag = true;
		return;
	}
...
// Sight
MONSTERINFO_SIGHT(shalrath_strogg_sight) (edict_t* self, edict_t* other) -> void
{
	gi.sound(self, CHAN_VOICE, sound_sight, 1, ATTN_NORM, 0);
}

// Search
MONSTERINFO_SEARCH (shalrath_strogg_search) (edict_t *self) -> void
{
...
void SP_monster_shalrath_strogg(edict_t *self)
{
	...
	self->s.modelindex = gi.modelindex("models/monsters/shalrathstrogg/tris.md2");	
	gi.modelindex("models/monsters/shalrathstrogg/gibs/g_arm.md2");
	gi.modelindex("models/monsters/shalrathstrogg/gibs/g_leg.md2");
	gi.modelindex("models/monsters/shalrathstrogg/gibs/g_head.md2");
