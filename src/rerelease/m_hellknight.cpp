...
// Stand
mframe_t hellknight_frames_stand [] =
{
	{ai_stand, 0, NULL},
	{ai_stand, 0, NULL},
	{ai_stand, 0, NULL},
...
MMOVE_T(hellknight_move_stand) = {0, 8, hellknight_frames_stand, NULL};

MONSTERINFO_STAND(hellknight_stand) (edict_t *self) -> void
{
	M_SetAnimation(self, &hellknight_move_stand);	
}

// Charge
mframe_t hellknight_frames_charge [] =
{
	{ai_charge, 20,	NULL},
	{ai_charge, 25,	NULL},
	{ai_charge, 18,	NULL},
...
MMOVE_T(hellknight_move_charge) = {63, 78, hellknight_frames_charge, hellknight_run};
...
mframe_t hellknight_frames_run [] =
{
...
MMOVE_T(hellknight_move_run) = {29, 36, hellknight_frames_run, NULL};

MONSTERINFO_RUN (hellknight_run) (edict_t *self) -> void
{
	M_SetAnimation(self, &hellknight_move_run);	
}

// walk
mframe_t hellknight_frames_walk[] =
{
	{ai_walk, 2, NULL},
	{ai_walk, 5, NULL},
	{ai_walk, 5, NULL},
...
MMOVE_T(hellknight_move_walk) = { 9, 28, hellknight_frames_walk, NULL };

MONSTERINFO_WALK(hellknight_walk) (edict_t* self) -> void
{
	M_SetAnimation(self, &hellknight_move_walk);
}

void hellknight_reset_magic(edict_t *self)
{
	self->radius_dmg = -2;
...
// Attack
mframe_t hellknight_frames_attack [] =
{
	{ai_charge, 0, NULL},
	{ai_charge, 0, NULL},
	{ai_charge, 0, NULL},
...
MMOVE_T(hellknight_move_attack) = {155, 165, hellknight_frames_attack, hellknight_run};

MONSTERINFO_ATTACK (hellknight_attack) (edict_t *self) -> void
{
	//if (CheckForCharge(self))
	//	M_SetAnimation(self, &hellknight_move_charge);	
...
// Slice
mframe_t hellknight_frames_slice [] =
{
	{ai_charge, 9,	NULL},
	{ai_charge, 6,	NULL},
	{ai_charge, 13,	NULL},
...
MMOVE_T(hellknight_move_slice) = {112, 121, hellknight_frames_slice, hellknight_run};

// Smash
mframe_t hellknight_frames_smash [] =
{
	{ai_charge, 1,	NULL},
	{ai_charge, 13,	NULL},
	{ai_charge, 9,	NULL},
...
MMOVE_T(hellknight_move_smash) = {122, 132, hellknight_frames_smash, hellknight_run};

// Watk
mframe_t hellknight_frames_watk [] =
{
	{ai_charge, 2, NULL},
	{ai_charge, 0, NULL},
	{ai_charge, 0, NULL},
...
MMOVE_T(hellknight_move_watk) = {133, 154, hellknight_frames_watk, hellknight_run};

// Melee
MONSTERINFO_MELEE (hellknight_melee) (edict_t *self) -> void
{
	self->dmg_radius++;
...
// Pain
mframe_t hellknight_frames_pain [] =
{
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
	{ai_move, 0, NULL},
...
MMOVE_T(hellknight_move_pain)= {37, 41, hellknight_frames_pain, hellknight_run};

PAIN (hellknight_pain)(edict_t* self, edict_t* other, float kick, int damage, const mod_t& mod) -> void
{
	if (skill->value == 3)
		return;
...
void hellknight_dead(edict_t *self)
{
...
// Death (1)
mframe_t hellknight_frames_die1 [] =
{
	{ai_move, 0,		NULL},
	{ai_move, 10,	    NULL},
	{ai_move, 8,		NULL},
...
MMOVE_T(hellknight_move_die1) = {42, 53, hellknight_frames_die1, hellknight_dead};

// Death (2)
mframe_t hellknight_frames_die2 [] =
{
	{ai_move, 0,		NULL },
	{ai_move, 0,		NULL },
	{ai_move, 0,		NULL },
...
MMOVE_T(hellknight_move_die2) = {54, 62, hellknight_frames_die2, hellknight_dead};

DIE (hellknight_die)(edict_t* self, edict_t* inflictor, edict_t* attacker, int damage, const vec3_t& point, const mod_t& mod) -> void
{
	if (self->health <= self->gib_health){
		...
		ThrowGibs(self, damage, {
			...
			{ "models/monsters/hellknight/gibs/g_arm.md2" },
			{ "models/monsters/hellknight/gibs/g_arm.md2" },
			{ "models/monsters/hellknight/gibs/g_leg.md2" },
			{ "models/monsters/hellknight/gibs/g_leg.md2" },
			{ "models/monsters/hellknight/gibs/g_head.md2", GIB_HEAD }
			});
		self->deadflag = true;
		return;
	}
...
// Sight
MONSTERINFO_SIGHT (hellknight_sight) (edict_t* self, edict_t* other) -> void
{
	gi.sound(self, CHAN_VOICE, sound_sight, 1, ATTN_NORM, 0);
}

// Search
MONSTERINFO_SEARCH(hellknight_search) (edict_t *self) -> void
{
	gi.sound(self, CHAN_VOICE, sound_search, 1, ATTN_NORM, 0);
}

MONSTERINFO_SETSKIN(hellknight_setskin) (edict_t* self) -> void
{
...
void SP_monster_hellknight(edict_t *self)
{
	...
	self->s.modelindex = gi.modelindex("models/monsters/hellknight/tris.md2");
	gi.modelindex("models/monsters/hellknight/gibs/g_arm.md2");
	gi.modelindex("models/monsters/hellknight/gibs/g_leg.md2");
	gi.modelindex("models/monsters/hellknight/gibs/g_head.md2");
